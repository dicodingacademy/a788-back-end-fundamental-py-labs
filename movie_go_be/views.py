...
from .models import Movie, Studio, StudioManager, Seat, Showtime, Reservation, ReservedSeat
from .serializers import MovieSerializer, StudioSerializer, StudioManagerSerializer, SeatSerializer, ShowtimeSerializer, ReservationSerializer, ReservedSeatSerializer
